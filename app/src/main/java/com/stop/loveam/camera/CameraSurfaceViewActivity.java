...
public class CameraSurfaceViewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    void surfaceViewAddJPG(String Url){
        Intent intent = new Intent(this, CameraSurActivity.class);
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                if (bitmap != null) {
                    ...
                    try {
                        ...
                        Log.d("CameraSurfaceViewActivity", "takePicture: " + e.getMessage());
                    } finally {
                        surfaceViewAddJPG(path);
                    }
                }
                CameraUtils.startPreview();
            }
