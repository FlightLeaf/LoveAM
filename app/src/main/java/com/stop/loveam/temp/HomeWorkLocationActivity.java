...
public class HomeWorkLocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_work_location);
        tv_location = findViewById(R.id.tv_location);
        ActivityCompat.requestPermissions(this, new
                String[]{Manifest.permission.ACCESS_FINE_LOCATION,Manifest.permission.CAMERA }, 1);
    }
    ...
    private void initLocation() {
        ...
        mCriteria.setAccuracy(Criteria.ACCURACY_FINE); // 设置是否需要海拔信息
        mCriteria.setAltitudeRequired(true);  // 设置是否需要方位信息
        mCriteria.setBearingRequired(true);  // 设置是否允许运营商收费
        mCriteria.setCostAllowed(true);   // 设置对电源的需求
        mCriteria.setPowerRequirement(Criteria.POWER_LOW);     // 获取定位管理器的最佳定位提供者
        String bestProvider = mLocationMgr.getBestProvider(mCriteria, false);
        ...
        if (mLocationMgr.isProviderEnabled(bestProvider)) { // 定位提供者当前可用
            ...
            // 设置定位管理器的位置变更监听器
            mLocationMgr.requestLocationUpdates(bestProvider, 3000, 0, mLocationListener);
            // 获取最后一次成功定位的位置信息
    ...
    private void setLocationText(Location location) {
        if (location != null) {
            ...
            new Thread(){public void run(){
                ...
                params.put("username", "liujianhang");
//                String strUrlPath = "http://58.87.74.112:8080/2016/android/saveLocation.jsp";
//                final String strResult=MyTools.submitPostData(strUrlPath,params, "utf-8",0);
            }}.start();
